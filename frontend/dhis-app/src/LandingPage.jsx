      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 20, flex: 1 }}>
            <div style={{ width: 56, height: 56, borderRadius: 16, background: "rgba(29,158,117,0.15)", border: "1px solid rgba(29,158,117,0.3)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 26, flexShrink: 0 }}>🏥</div>
            <div>
              <div style={{ color: "#fff", fontWeight: 700, fontSize: 20, marginBottom: 6 }}>Patient Registration & Login</div>
              <div style={{ color: "#8ba8c8", fontSize: 13, lineHeight: 1.6, maxWidth: 420 }}>
                Register as a new patient or log in using your Patient ID and password. Access your health records across all 18 districts of West Bengal.
              </div>
            </div>
          </div>
          ...
          <div style={{ flexShrink: 0 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 10, justifyContent: "center" }}>
              ...
              <span style={{ color: "#6ee7b7", fontSize: 11, fontWeight: 600 }}>Secure Password Access</span>
            </div>
          </div>
        </div>
      </div>
